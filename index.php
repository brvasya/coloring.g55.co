...
<?php if ($pager['has_prev']): ?><a class="tag" href="<?php echo htmlspecialchars($prevUrl) ?>">Prev Page</a><?php endif; ?>
<?php if ($pager['has_next']): ?><a class="tag" href="<?php echo htmlspecialchars($nextUrl) ?>">Next Page</a><?php endif; ?>
</nav>
<?php endif; ?>
